...
function App() {
  ...
  return (
    <div className="min-h-screen p-5 relative">
      {/* Header */}
      <header className="bg-gradient-to-r from-white/98 to-white/95 p-6 px-10 rounded-2xl shadow-xl mb-8 border border-white/30 backdrop-blur-md hover:shadow-2xl transition-all duration-300 max-w-7xl mx-auto">
